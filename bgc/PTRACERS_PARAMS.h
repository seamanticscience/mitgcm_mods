...
C     JML PTRACERS_prefSurfTauRelax :: Timescale of relaxation of preformed tracers 
C                                   to surface values (see GCHEM_PREFORMED_TRACERS)
      ...
      _RL PTRACERS_prefSurfTauRelax(PTRACERS_num)
