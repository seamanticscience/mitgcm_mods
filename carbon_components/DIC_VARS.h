...
#ifdef DIC_CARBON_COMPONENTS      
       COMMON /CARBON_COMPONENTS/
     &     pH_INIT, pH_INSIT, pH_GLOB, dic_pCO2_init,
     &     ak03d,ak13d,ak23d,akw3d,akb3d,aks3d,akf3d,
     &     ak1p3d,ak2p3d,ak3p3d,aksi3d, fugf3d, 
     &     ff3d,ft3d,st3d,bt3d, Ksp_TP_Calc3d       
       _RL  pH_INIT       (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
       _RL  pH_INSIT      (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
       _RL  pH_GLOB       (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
       _RL  dic_pCO2_init (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
       
      _RL  ak03d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  ak13d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  ak23d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  akw3d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  akb3d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  aks3d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  akf3d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  ak1p3d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  ak2p3d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  ak3p3d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  aksi3d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  ff3d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
C Fugacity Factor added by Val Bennington Nov. 2010
      _RL  fugf3d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  ft3d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  st3d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  bt3d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  Ksp_TP_Calc3d(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
#endif
