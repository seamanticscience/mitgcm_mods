...
C                       for air-sea CO2 and O2 flux calculations.
     ...
     &              selectK1K2const
      ...
      _RL  hco3(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  co2aq(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
C Make Silica 3d
...
#ifdef DIC_CARBON_COMPONENTS
       COMMON /CARBON_CHEM/
     &     pH_ini, pH_loc, pH_glob, dic_pCO2_ini,
     &     aphscale,
     &     ak0,ak1,ak2,akw,akb,aks,akf,
     &     ak1p,ak2p,ak3p,aksi, fugf,
     &     ff,ft,st,bt,cat,
     &     Ksp_TP_Calc, Ksp_TP_Arag      
      _RL  pH_ini       (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  pH_loc       (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  pH_glob      (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  aphscale     (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  dic_pCO2_ini (1-OLx:sNx+OLx,1-OLy:sNy+OLy,nSx,nSy)
      _RL  ak0(1-OLx:sNx+OLx,1-OLy:sNy+OLy, Nr,nSx,nSy)
      _RL  ak1(1-OLx:sNx+OLx,1-OLy:sNy+OLy, Nr,nSx,nSy)
      _RL  ak2(1-OLx:sNx+OLx,1-OLy:sNy+OLy, Nr,nSx,nSy)
      _RL  akw(1-OLx:sNx+OLx,1-OLy:sNy+OLy, Nr,nSx,nSy)
      _RL  akb(1-OLx:sNx+OLx,1-OLy:sNy+OLy, Nr,nSx,nSy)
      _RL  aks(1-OLx:sNx+OLx,1-OLy:sNy+OLy, Nr,nSx,nSy)
      _RL  akf(1-OLx:sNx+OLx,1-OLy:sNy+OLy, Nr,nSx,nSy)
      _RL  ak1p(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  ak2p(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  ak3p(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  aksi(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  ff(1-OLx:sNx+OLx,1-OLy:sNy+OLy,  Nr,nSx,nSy)
C Fugacity Factor added by Val Bennington Nov. 2010
      _RL  fugf(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  ft  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  st  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  bt  (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  cat (1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  Ksp_TP_Calc(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
      _RL  Ksp_TP_Arag(1-OLx:sNx+OLx,1-OLy:sNy+OLy,Nr,nSx,nSy)
#else
       COMMON /CARBON_CHEM/
     &                     ak0,ak1,ak2,akw,akb,aks,akf,
     &                     ak1p,ak2p,ak3p,aksi, fugf,
...
C JML include iron source due to hydrothermal input into bottom layer  
     ...
     &        dic_pCO2, dic_pCO2_ref
      ...
      COMMON /TRACER_INDECES/
     &     iDIC , iALK , iPO4 , iDOP , iDO2 , iDFE,
     &     iCPRE, iAPRE, iPPRE, iOPRE, iPCO2, iAGE, 
     &     iCSAT, iCDIS
